...
jsPsych.plugins["html-keyboard-word-response"] = (function () {
    ...
    plugin.trial = function (display_element, trial) {
        ...
        var show_feedback = function () {
            ...
            if (trial.language == 'dutch') {
                if (correct) {
                    feedback = '<p>Goed!</p>';
                } else if (timed_out) {
                    feedback = '<p>Te langzaam... Het goede antwoord was: <b>' + trial.question.answer + '</b></p>';
                } else {
                    feedback = '<p>Fout! Het goede antwoord was: <b>' + trial.question.answer + '  ' + trial.question.exp + '</b></p>';
                }
            }

            if (trial.language == 'german') {
                if (correct) {
